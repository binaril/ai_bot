...
class ChromaIndexer:
    def __init__(self, embeddings_dir: str, host: str, port: int):
        self.embeddings_dir = Path(embeddings_dir)
        self.chroma_host = host
...
def main():
    ...
    parser.add_argument("-c", "--chroma-host", default="localhost")
    parser.add_argument("-p", "--chroma-port", default="8000")
    args = parser.parse_args()

    indexer = ChromaIndexer(args.embeddings_dir, args.chroma_host, args.chroma_port)
